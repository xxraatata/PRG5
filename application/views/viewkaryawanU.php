  ...
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <a class="navbar-brand brand-logo mr-5" href="<?php echo base_url ('assets/index.html'); ?>"><img src="<?php echo base_url('assets/images/logo.svg'); ?>" class="mr-2" alt="logo"/></a>
        ...
        <ul class="navbar-nav navbar-nav-right">
          ...
          <li class="nav-item nav-profile dropdown">
            <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" id="profileDropdown">
              <img src="<?php echo base_url('assets/images/faces/face30.png'); ?>" alt="profile"/>
            </a>
    ...
    <ul class="nav">
        ...
        <li class="nav-item">
            <a class="nav-link" href="<?php echo base_url().'KaryawanC'; ?>">
                ...
                <span class="menu-title">Create Karyawan</span>
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="<?php echo base_url().'ReadKaryawanC'; ?>">
                <i class="icon-paper menu-icon"></i>
                <span class="menu-title">Read Karyawan</span>
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="<?php echo base_url().'UpdateKaryawanC'; ?>">
                <i class="icon-paper menu-icon"></i>
                <span class="menu-title">Update Karyawan</span>
            </a>
        </li>
    </ul>
</nav>
        <!-- Read Karyawan Section -->
        <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Daftar Karyawan</h4>
                        <p class="card-description">Data Karyawan yang Tersimpan</p>
                                ...
                                <?php if (!empty($karyawan)) : ?>
                                    <?php foreach ($karyawan as $k) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?php echo site_url('readkaryawanc/show/' . $k['id']); ?>" class="btn btn-info">Lihat</a>
                                            </td>
                                            <td>
                                                <!-- Delete button -->
                                                <?php echo form_open('updatekaryawanc/delete/'.$k['id']); ?>
                                                    <button type="submit" onclick="return confirm('Are you sure you want to delete this employee?')" class="btn btn-info">Delete</button>
                                                <?php echo form_close(); ?>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
        ...
        <footer class="footer">
          <div class="d-sm-flex justify-content-center justify-content-sm-between">
            <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright © 2021.  Premium <a href="<?php echo base_url('https://www.bootstrapdash.com/'); ?>" target="_blank">Bootstrap admin template</a> from BootstrapDash. All rights reserved.</span>
            <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center">Hand-crafted & made with <i class="ti-heart text-danger ml-1"></i></span>
          </div>
          <div class="d-sm-flex justify-content-center justify-content-sm-between">
            <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Distributed by <a href="<?php echo base_url('https://www.themewagon.com/'); ?>" target="_blank">Themewagon</a></span> 
          </div>
        </footer> 
        <!-- partial -->
      </div>
